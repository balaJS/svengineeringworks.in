			...
			<div class="row">
				...
				<div class="col-md-5">
					<form action="backend.php" method="post" enctype="#">
						...
						<div class="form-group">
						    <label for="mobile">Amount:</label>
						    <input type="number" class="form-control" name="amount" id="amount" required value="<?php echo $data['amount'];?>">
						</div>
						...
						<div class="form-group">
						    ...
						    <select class="form-control" name="status">
						    	<option value="Y" <?php if($data['status']=='Y'){echo 'selected';}?> >Active</option>
						    	<option value="N" <?php if($data['status']=='N'){echo 'selected';}?>>In-Active</option>
						    </select>
						</div>
